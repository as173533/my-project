    ...
    <div class="logo-sec">
        <div class="clearfix d-flex">
            <div class="col-xs-6 col-6">
                <a href="{{ Route('admin-profile') }}"><img src="{{ URL::asset('public/backend/images/dash_logo.png') }}" alt="" class="img-responsive"></a>
            </div>
...
<!--                    <li class="{{ ($controller=='FaqController') ? 'active' : '' }}">
            ...
            <li class="{{ ($controller=='ProjectController') ? 'active' : '' }}"><a href="{{Route('admin-project-index')}}"><i class="fa fa-picture-o" aria-hidden="true"></i> Projects</a></li>
