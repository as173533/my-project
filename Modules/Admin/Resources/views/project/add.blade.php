        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Add Project</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-project-store')}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                        ...
                        <div class="form-group {{ $errors->has('link') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Link" name="link" value="{{ (old('link')!="") ? old('link') : ''}}"/>
                                @if ($errors->has('link'))
